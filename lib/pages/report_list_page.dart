...
import 'package:aplikasi_laporan_sampah/pages/history_page.dart';
...
class ReportListTab extends StatefulWidget {
  final String
  statusFilter; // The status to filter by (e.g., 'masuk', 'proses', 'selesai')
  final Future<ListLaporanResponse>?
  futureReports; // Pass the future from parent
...
class _ReportListTabState extends State<ReportListTab>
  ...
  Future<void> _updateReportStatus(String reportId, String newStatus) async {
    ...
    try {
      ...
      final historyPageState =
          context.findAncestorStateOfType<HistoryPageState>();
  ...
  void _showUpdateStatusBottomSheet(Data report) {
    // Removed onRefreshParent from signature
                ...
                child: InkWell(
                  ...
                  onLongPress: () {
                    _showUpdateStatusBottomSheet(
                      report,
                    ); // Removed onRefreshParent from here
                  },
                  child: Padding(
                    padding: const EdgeInsets.all(16.0),
                    child: Column(
